...
| Ontology | `ontology/supply_chain.yaml` | Defines entities, relationships, and operation types |
...
These are real queries generated by Claude Code during benchmarking. See `BENCHMARK_STUDY/question_inventory.md` for all 60 benchmark questions and `queries.md` for the complete query catalogue.
