...
*   **Scale**: ~11.4M rows across 70 tables (SCOR-DS model: Plan, Source, Transform, Order, Fulfill, Return).
...
*   **FMCG Database**:
    ...
    *   `make fmcg-generate`: Generate the ~11.4M row seed dataset.
...
5.  **Validation**: Verify results against the "Named Test Entities" (e.g., `B-2024-RECALL-001` for recall tracing) when debugging.
